...
public class Motion {
	...
	public void setDirection(double dir) {
		direction = Utilities.mod(dir, 360);
		updateCartesianMovements();
	}
	...
	private void updatePolarMovements() {
		...
		direction = Utilities.mod(direction, 360);//put direction in the proper range
	}
	...
	/**@return this instance's hspeed*/ public double getHspeed() { return hspeed; }
	/**@return this instance's vspeed*/ public double getVspeed() { return vspeed; }
	...
	/**
	 * This is a background processing method that updates the position of the instance according to its speed and direction. Don't call it.
	 */
	...
	/**
	 * This is a background processing method that updates the value of previousPosition. Don't call it.
	 */
